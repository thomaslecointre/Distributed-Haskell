...
parseKeywordSeriesSeasonEpisode (keyword:serie:season:episode:[]) = (keyword, read season :: Int, read episode :: Int, "http://10.57.110.10:8081/public/" ++ serie ++ "/" ++ season ++ "/" ++ episode)
